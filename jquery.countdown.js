    ...
    $.extend(CountDown.prototype, {
        ...
        markup: function () {
            ...
            var html = [
                ...
                '</span>',
                '<span class="separator seperator-hh">', this.options.separator, '</span>',
                '<span class="item item-mm">',
                    '<span class="mm-1"></span>',
                    '<span class="mm-2"></span>',
                    '<span class="label label-mm">', this.options.label_mm, '</span>',
                '</span>',
                '<span class="separator seperator-mm">', this.options.separator, '</span>',
                '<span class="item item-ss">',
                    '<span class="ss-1"></span>',
                    '<span class="ss-2"></span>',
            ...
            this.item_hh       = this.timeElement.find('.item-hh');
            this.separator_hh  = this.timeElement.find('.separator-hh');
            this.item_mm       = this.timeElement.find('.item-mm');
            this.separator_mm  = this.timeElement.find('.separator-mm');
        ...
        displayRemainingTime: function (remaining) {
            ...
            if (!this.options.always_show_hours && remaining.hh === '0') {
                this.item_hh.remove();
                this.separator_hh.remove();
            }
            // Remove minutes if necessary.
            if (!this.options.always_show_minutes && remaining.mm === '0') {
                this.item_mm.remove();
                this.separator_mm.remove();
            }
